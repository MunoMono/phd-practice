...
# Apply migration 004
docker exec -i phd-practice-db psql -U postgres -d testamentary-traces < /path/to/004_ml_enrichment_schema.sql

# Verify pgvector extension
docker exec phd-practice-db psql -U postgres -d testamentary-traces -c "\dx"
```
...
docker exec phd-practice-db psql -U postgres -d testamentary-traces -c "CREATE EXTENSION IF NOT EXISTS vector;"
```
