...
selector = TurinRetrievalV312AuthorityResolution()
cases = []
for case in fixture["cases"]:
    ...
    final, sources, chunks = result["final_documentary_passages"], set(case["expected_canonical_assets"]), set(case["expected_passage_chunk_ids"])
